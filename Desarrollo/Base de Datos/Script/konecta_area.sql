...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id_area`),
  KEY `R_24` (`id_departamento`),
  CONSTRAINT `area_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`)
...
INSERT INTO `area` VALUES ('128','Finanzas'),('FI_123','Finanzas');
